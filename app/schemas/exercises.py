...
class ExerciseUpdate(BaseModel):
    ...
    primary_muscle: Optional[ExerciseMuscle] = Field(default=None, description="Primary muscle group targeted")
    equipment: Optional[ExerciseEquipment] = Field(default=None, description="Equipment used")
...
class ExercisesFilterParams(BaseModel):
    name: str | None = Field(default=None, description="Exercise name has to contain this phrase")
